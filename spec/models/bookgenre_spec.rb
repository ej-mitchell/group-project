...
RSpec.describe 'Bookgenre' do
  context 'makes a relation between book and genre' do
    let(:book) { Book.new(title: "Game of Thrones", author: "George R.R. Martin", page_number: 800, summary: "First book in the Song of Ice and Fire series.", cover_photo: "https://images-na.ssl-images-amazon.com/images/I/51bcsc2fcFL.jpg") }
