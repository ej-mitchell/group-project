...
describe Book do
  ...
  it { should have_valid(:cover_photo).when('https://images-na.ssl-images-amazon.com/images/I/51bcsc2fcFL.jpg') }
...
RSpec.describe 'Book' do
  context 'making a new book' do
    ...
    let(:book) { Book.new(title: "Game of Thrones", author: "George R.R. Martin", page_number: 800, summary: "First book in the Song of Ice and Fire series.", cover_photo: "https://images-na.ssl-images-amazon.com/images/I/51bcsc2fcFL.jpg", user_id: user.id) }
